...
using Simle.System.WapSite.Models;

namespace Simle.System.WapSite.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("Simle.System.WapSite.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("Simle.System.WapSite.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
